...
export default function ProfileForm() {
    ...
    return(
        <div className="flex min-h-screen lg:w-full flex-col items-center justify-between">
            <form onSubmit={onSubmitUserUpdated}
            className="md:w-1/2 flex flex-col w-80 border-2 rounded-lg mt-20 mb-6 pt-4 items-center bg-white shadow-xl shadow-violet-600">
                ...
                <div className="flex flex-col m-1 w-4/5 md:w-2/3">
                    ...
                    <div className="mb-2">
                        <label htmlFor="input" className="block mb-2 text-sm font-medium text-primary">Nombre</label>
                    ...
                    <div className="mb-2 ">
                        <label htmlFor="input" className="block mb-2 text-sm font-medium text-primary">Apellido</label>
                        <input type="text" id="lastName" {...register("lastName")}
                        className="block p-1 input-xs md:input-sm md:w-full text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base"/>
                    </div>
                    <div className="mb-2 flex flex-col md:flex-row space-y-2 md:space-y-0">
                        <div className="md:w-1/2">
                            <label htmlFor="input" className="block mb-2 text-sm font-medium text-primary">Fecha de Nacimiento</label>
                            <input type="date" id="birthdate" {...register("birthdate")}
                            className="block p-1 input-xs md:input-sm md:w-full text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base"/> 
                        </div>
                        <div className="dropdown dropdown-bottom md:ml-2 md:w-1/2">
                            <label htmlFor="dropdown" className="flex md:justify-center text-sm font-medium text-primary my-1">Sexo Biologico</label>
                    ...
                    <div className="mb-2">
                        <label htmlFor="input" className="block mb-2 text-sm font-medium text-primary">Telefono</label>
                        <input type="text" id="telephone" {...register("telephone")}
                        className="block p-1 input-xs md:input-sm md:w-full text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base"/>
                    </div>
                    <div className="mb-2">
                        <label htmlFor="input" className="block mb-2 text-sm font-medium text-primary">Domicilio</label>
